...
/*!
 * \brief Packs changeset's unserialized data into its 'data' field.
 * 
 * \param ch  Pack this changeset.
 * 
 * \return KNOT_E*
 */
 ...
 * 
 * \param ch  Unpack this changeset.
 * 
 * \return KNOT_E*
 */
int changeset_unpack(changeset_t *ch);
